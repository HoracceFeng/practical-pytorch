...
if __name__ == '__main__':
    ...
    #     if e % log_every == 0:
    #         print('[epoch=%d]  reward_avg %.3f value_loss_avg %.3f' %(e, reward_avg.value, value_loss_avg.value))
    ...
    while reward_avg < 0.75:
        ...
        filename = 'video/' + str(e) + '.mp4'
        
        if e % log_every == 0:
            # print('[epoch=%d]' % e, reward_avg, value_avg)
            print('[epoch=%d]  reward_avg %.3f value_loss_avg %.3f final_reward %.3f' %(e, reward_avg.value, value_avg.value, final_reward))
        
        if e > 0 and e % render_every == 0:
            animate(env.history, filename=filename)
